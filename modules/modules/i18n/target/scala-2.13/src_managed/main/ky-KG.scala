...
private object `ky-KG` {
  ...
  def load: java.util.HashMap[MessageKey, Translation] = {
    val m = new java.util.HashMap[MessageKey, Translation](137)
...
m.put("youPlayTheWhitePieces",new Simple("""Сиз ак фигуралар менен ойнойсуз"""))
m.put("youPlayTheBlackPieces",new Simple("""Сиз кара фигуралар менен ойнойсуз"""))
m.put("itsYourTurn",new Simple("""Сиздин жүрүшүңүз!"""))
...
m.put("opponentLeftCounter",new Plurals(new Map.Map2(One,"""Каршылаш оюндан чыкты. Сиз %s секундтан кийин жеңишти талап кылсаңар болот.""",Other,"""Каршылаш оюндан чыкты. Сиз %s секундтан кийин жеңишти талап кылсаңар болот.""")))
...
m.put("blunder",new Simple("""Одоно жаңылыштык"""))
m.put("blunders",new Simple("""Одоно ката"""))
m.put("mistake",new Simple("""Жыңылыштык"""))
m.put("mistakes",new Simple("""Жаңылыштык"""))
m.put("inaccuracy",new Simple("""Так эместик"""))
m.put("inaccuracies",new Simple("""Так эместик"""))
m.put("moveTimes",new Simple("""Жүрүштөрдүн убактысы"""))
m.put("flipBoard",new Simple("""Досканы оодаруу"""))
m.put("threefoldRepetition",new Simple("""Позициянын үч ирет кайталануусу"""))
m.put("claimADraw",new Simple("""Эч ким уткан жок дегенди сунуш кылуу"""))
m.put("offerDraw",new Simple("""Эч ким уткан жок дегенди сунуш кылуу"""))
m.put("draw",new Simple("""Ничья"""))
m.put("currentGames",new Simple("""Азыркы оюндар"""))
m.put("viewInFullSize",new Simple("""Кененирек көрүү"""))
...
m.put("activity:activity",new Simple("""Активдүүлүк"""))
m.put("activity:hostedALiveStream",new Simple("""Стрим жүргүзүлдү"""))
m.put("activity:solvedNbPuzzles",new Plurals(new Map.Map2(One,"""%s тактикалык маселе чечилди""",Other,"""%s тактикалык маселелер чечилди""")))
m.put("activity:playedNbMoves",new Plurals(new Map.Map2(One,"""%1$s жүрүш кылынды""",Other,"""%1$s жүрүш кылынды""")))
    m
  }
}
