...
private object `sw-KE` {
  ...
  def load: java.util.HashMap[MessageKey, Translation] = {
    val m = new java.util.HashMap[MessageKey, Translation](93)
...
m.put("gameOver",new Simple("""Mchezo umekwisha"""))
m.put("waitingForOpponent",new Simple("""Subiri mpinzani"""))
m.put("waiting",new Simple("""Subiri"""))
...
m.put("toggleSound",new Simple("""Badili Sauti"""))
...
m.put("youPlayTheWhitePieces",new Simple("""Unacheza na nyeupe"""))
m.put("youPlayTheBlackPieces",new Simple("""Unacheza na nyeusi"""))
m.put("itsYourTurn",new Simple("""Nafasi ni yako!"""))
...
m.put("study:onlyPublicStudiesCanBeEmbedded",new Simple("""Masomo tu ya umma yanaweza kupachikwa!"""))
m.put("preferences:preferences",new Simple("""Upendeleo"""))
m.put("preferences:gameDisplay",new Simple("""Onyesho la mchezo"""))
m.put("tourname:hourlyRapidArena",new Simple("""Sataranji ya kila saa { 10+0}"""))
    m
  }
}
